...
def start(message):
    bot.send_message(message.from_user.id, 'Привет!! Отправь мне голосовое или текстовое сообщение, и я тебе отвечу!')


@bot.message_handler(commands=['help'])
def help(message):
    bot.send_message(message.from_user.id, 'Чтобы начать, просто отправь мне голосовое или текстовое сообщение.')
...
def handler(message):
    bot.send_message(message.from_user.id, 'Я пока могу понимать тебя только в тексте или аудио. '
